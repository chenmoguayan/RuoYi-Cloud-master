  ...
  <div>
    ...
    <div id="haha">
      ...
      <el-row v-if="formorder">
        ...
        <el-button type="danger" @click="cash()">退费</el-button>
        <el-form>
...
import { addPay, updatePay} from "@/api/refund/refund";
...
export default {
  ...
  updated() {
    ...
    if (this.chargeableData.roStatus === 1){
      ...
      this.tableData.forEach(protect =>{
        ...
        this.tableDataUpdated.payType = '已退费';
  ...
  methods: {
     ...
     */
    cash(){
      console.log(this.coId+','+this.oId);
    ...
    clearData(){
      ...
      this.chargeableData.pName=undefined;
      this.chargeableData.coTotalAmonut=undefined;
